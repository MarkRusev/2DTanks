...
public class Brick {
//positions that bricks could be spawned
		...
		public Brick()
		{
			...
			//iterate through brickON array,and passing the value of 1 
		...
		//if brickON is 1 then paint the "soft" bricks
		...
		//with this method we are checking if the tank is over the brick
